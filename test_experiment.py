...
class experiment():
    ...
    def take_CHG(self,pstat, highPotentialLimit, CHGcurrent, CHGfilepath):
        # charge the cell very slowly
        # keep getting cwEPR until potential is reached.
        pstat.configureCHG(CHGcurrent)
        potential = pstat.getChgPoint()
        while potential < highPotentialLimit:
            print('get cwEPR')
            print('keep charging')
